...
class ToolPermissionManager:
    ...
    def set_profile_override(self, profile: PermissionProfile, tool_name: str, permission: ToolPermission, allowed_methods: List[str] = None, blocked_methods: List[str] = None) -> None:
